		...
		if (error) {
			switch (error) {
				case 'OAuthAccountNotLinked':
					toast.error(
						"Account not linked — your OAuth provider email doesn't match your existing account. Try logging in with your original method first, then connect the new provider.",
						{
							icon: '⛔️',
							duration: 8000,
						},
