...
export function Manifesto({
	...
	return (
		<section className="border-border grid grid-cols-1 gap-8 border-b px-8 py-12 sm:px-16 sm:py-0 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] md:gap-16">
			<h2 className="flex text-balance font-sans text-3xl font-semibold leading-tight tracking-tight sm:-mt-3 sm:self-start sm:py-16 sm:text-4xl md:sticky md:top-24 md:py-24">
				{headline}
			</h2>
