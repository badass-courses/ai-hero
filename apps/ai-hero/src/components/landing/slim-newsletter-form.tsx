	...
	return (
		<div className="flex w-full flex-col items-center gap-5">
			<SubscribeToConvertkitForm
				...
				className="[&_button]:bg-primary [&_button]:text-primary-foreground [&_button]:hover:bg-primary/90 [&_input]:border-foreground/15 [&_input]:bg-muted [&_input]:text-foreground [&_input]:placeholder:text-foreground/60 grid w-full grid-cols-1 gap-3 sm:grid-cols-[1fr_1fr_auto] [&_button]:h-14 [&_button]:rounded-full [&_button]:border-0 [&_button]:px-8 [&_button]:text-base [&_button]:font-semibold [&_input]:h-14 [&_input]:rounded-full [&_input]:border [&_input]:px-7 [&_input]:text-base [&_label]:hidden"
			/>
