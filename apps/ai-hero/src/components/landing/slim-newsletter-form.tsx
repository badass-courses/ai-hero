...
import { completeSkillsCourseSignup } from '@/app/(content)/skills/_components/skills-course-signup'
	...
	return (
		<div className="flex w-full flex-col items-center gap-3">
			<ConversionIntentForm
				...
				// It used to render the default "Thanks!" in place and stop — the one
				// course CTA on the site that never told the reader lesson one was
				// coming, or caught the inactive-subscriber case at all.
				onSuccess={(subscriber) =>
					completeSkillsCourseSignup(subscriber, router, () =>
						track('subscribed', { location: 'landing_newsletter_cta' }),
					)
				}
