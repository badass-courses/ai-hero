...
const EMPTY_OFFICE_HOURS_SESSIONS: CohortOfficeHoursSession[] = []

export type OfficeHoursScheduleProps = {
...
export function OfficeHoursSchedule({
	...
	const sessions = initialSessions ?? EMPTY_OFFICE_HOURS_SESSIONS
