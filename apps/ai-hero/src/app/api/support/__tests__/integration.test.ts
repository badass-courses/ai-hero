...
describe('AI Hero Support Integration', () => {
	...
	describe('getContentAccess', () => {
		...
		it('returns archive-derived access with source purchase visibility', async () => {
			mockAdapter.getEntitlementsForUser.mockResolvedValue([
				{
					id: 'ent-1',
					entitlementType: 'cohort_content_access',
					sourceId: 'purchase-archive-1',
					metadata: {
						archiveProductId: 'archive-product-1',
						archivePurchaseId: 'purchase-archive-1',
			...
			mockAdapter.getPurchasesForUser.mockResolvedValue([
				{
					id: 'purchase-archive-1',
					productId: 'archive-product-1',
					status: 'Valid',
					createdAt: new Date(),
					totalAmount: 99,
				},
			...
			expect(result.products).toEqual([
				{
					productId: 'archive-product-1',
					productName: 'AI Hero Archive (archive purchase purchase-archive-1)',
					accessLevel: 'full',
					modules: [
						{
							id: 'cohort-1',
							title: 'AI Hero Cohort 1 (archive entitlement)',
							accessible: true,
						},
					],
