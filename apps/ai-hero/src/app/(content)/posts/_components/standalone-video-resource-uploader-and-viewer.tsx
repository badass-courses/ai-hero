...
export default function StandaloneVideoResourceUploaderAndViewer() {
	...
	return (
		<ScrollArea className="h-(--pane-layout-height) [&>[data-slot=scroll-area-viewport]>div]:block!">
					...
					{standaloneVideoResources.map((videoResource) => (
						...
						>
							<div
								...
								draggable
								className="flex w-full min-w-0 items-center justify-between gap-2 px-3 py-1 leading-tight group-even/item:bg-gray-100 dark:group-even/item:bg-gray-950"
							>
