	...
	return (
		<main className="bg-background text-foreground">
			<section className="border-border grid border-b lg:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)]">
				<div className="flex flex-col justify-center gap-6 px-8 py-16 sm:px-11 sm:py-24 lg:py-28">
			...
			<section
				...
				className="border-border border-b px-8 py-16 sm:px-11 sm:py-24"
			>
			...
			<section className="px-8 py-14 sm:px-11 sm:py-20">
