...
import { LessonRouteSessionProvider } from './lesson-route-session-provider'
...
const LessonLayout = async (props: {
	...
	return (
		<LessonRouteSessionProvider session={session as Session | null}>
