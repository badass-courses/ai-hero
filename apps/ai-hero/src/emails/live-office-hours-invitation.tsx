...
import { buildEtzLink } from '@coursebuilder/utils/build-etz-link'
...
function generateCalendarLinks(
	...
	const encodedDescription = encodeURIComponent(
		`Join us for live office hours on YouTube. Ask questions, get unstuck, and follow along in real time.\n\nIf you miss it, the replay and transcript will be available afterwards.\n\nWatch live: ${liveLink}`,
	)
...
DTEND:${dtend}
SUMMARY:${eventTitle}
DESCRIPTION:Join us for live office hours on YouTube. Ask questions, get unstuck, and follow along in real time.\\n\\nIf you miss it, the replay and transcript will be available afterwards.\\n\\nWatch live: ${liveLink}
