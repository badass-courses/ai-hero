...
function buildShadowFieldPayload(args: {
	...
	return {
		...
		aih_ft_gclid: args.state.optInAttribution?.gclid ?? '',
		aih_ft_gbraid: args.state.optInAttribution?.gbraid ?? '',
		aih_ft_wbraid: args.state.optInAttribution?.wbraid ?? '',
		aih_ft_utm_source: args.state.optInAttribution?.utmSource ?? '',
		aih_ft_utm_medium: args.state.optInAttribution?.utmMedium ?? '',
		aih_ft_utm_campaign: args.state.optInAttribution?.utmCampaign ?? '',
		aih_ft_utm_content: args.state.optInAttribution?.utmContent ?? '',
		aih_ft_utm_term: args.state.optInAttribution?.utmTerm ?? '',
		aih_ft_landing_path: args.state.optInAttribution?.landingPath ?? '',
		aih_ft_captured_at: args.state.optInAttribution?.capturedAt ?? '',
	}
}
