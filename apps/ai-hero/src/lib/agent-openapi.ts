...
import {
	...
	ProductResourceAttachRequestSchema,
	ProductResourceAttachResponseSchema,
...
const contentPaths = {
	...
	'/api/products/{productId}/resources': {
		parameters: [pathParameter('productId', 'Product id.')],
		options: preflight('preflightProductResources'),
		post: contentOperation({
			operationId: 'attachProductResource',
			summary: 'Attach a resource to a product',
			description: 'Attach an existing resource at the end of the product list. Re-attaching an active relation returns its existing position; a soft-deleted relation is restored. Multiple resources per product are allowed.',
			access: 'device-token',
			requiredAbility: 'update Content',
			requestSchema: 'ProductResourceAttachRequest',
			responseSchema: 'ProductResourceAttachResponse',
			extraResponses: commonErrorResponses,
		}),
	},
	'/api/products': {
...
const zodSchemas = {
	...
	ProductResourceAttachRequest: ProductResourceAttachRequestSchema,
	ProductResourceAttachResponse: ProductResourceAttachResponseSchema,
