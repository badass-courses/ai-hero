...
/**
 * Renders the full robots.txt body: one group per user agent (wildcard plus
 * each named AI crawler), each carrying the site's Content Signals, followed
 * by the XML and Markdown sitemap directives.
 */
