/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: f3ab1c51153333d25ebf3330f38321d2)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 
interface __BaseEnv_Env {
	TRACER_ENABLED: string;
	STATUS_AUTOMATION_ENABLED: string;
	STATUS_PUBLIC_WRITES_ENABLED: string;
	INCIDENTS: DurableObjectNamespace<import("./src/index").IncidentStore>;
}
